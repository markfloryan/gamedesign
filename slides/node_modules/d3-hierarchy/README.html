...
<div class="sourceCode" id="cb1"><pre class="sourceCode html"><code class="sourceCode html"><span id="cb1-1"><a href="#cb1-1" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-hierarchy.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-2"><a href="#cb1-2" aria-hidden="true"></a><span class="kw">&lt;script&gt;</span></span>
<span id="cb1-3"><a href="#cb1-3" aria-hidden="true"></a></span>
<span id="cb1-4"><a href="#cb1-4" aria-hidden="true"></a><span class="kw">var</span> treemap <span class="op">=</span> d3<span class="op">.</span><span class="fu">treemap</span>()<span class="op">;</span></span>
...
<span id="cb2-2"><a href="#cb2-2" aria-hidden="true"></a>  <span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Eve&quot;</span><span class="fu">,</span></span>
<span id="cb2-3"><a href="#cb2-3" aria-hidden="true"></a>  <span class="dt">&quot;children&quot;</span><span class="fu">:</span> <span class="ot">[</span></span>
<span id="cb2-4"><a href="#cb2-4" aria-hidden="true"></a>    <span class="fu">{</span></span>
<span id="cb2-5"><a href="#cb2-5" aria-hidden="true"></a>      <span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Cain&quot;</span></span>
...
<span id="cb2-8"><a href="#cb2-8" aria-hidden="true"></a>      <span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Seth&quot;</span><span class="fu">,</span></span>
<span id="cb2-9"><a href="#cb2-9" aria-hidden="true"></a>      <span class="dt">&quot;children&quot;</span><span class="fu">:</span> <span class="ot">[</span></span>
<span id="cb2-10"><a href="#cb2-10" aria-hidden="true"></a>        <span class="fu">{</span></span>
<span id="cb2-11"><a href="#cb2-11" aria-hidden="true"></a>          <span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Enos&quot;</span></span>
<span id="cb2-12"><a href="#cb2-12" aria-hidden="true"></a>        <span class="fu">}</span><span class="ot">,</span></span>
<span id="cb2-13"><a href="#cb2-13" aria-hidden="true"></a>        <span class="fu">{</span></span>
<span id="cb2-14"><a href="#cb2-14" aria-hidden="true"></a>          <span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Noam&quot;</span></span>
<span id="cb2-15"><a href="#cb2-15" aria-hidden="true"></a>        <span class="fu">}</span></span>
<span id="cb2-16"><a href="#cb2-16" aria-hidden="true"></a>      <span class="ot">]</span></span>
<span id="cb2-17"><a href="#cb2-17" aria-hidden="true"></a>    <span class="fu">}</span><span class="ot">,</span></span>
<span id="cb2-18"><a href="#cb2-18" aria-hidden="true"></a>    <span class="fu">{</span></span>
<span id="cb2-19"><a href="#cb2-19" aria-hidden="true"></a>      <span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Abel&quot;</span></span>
<span id="cb2-20"><a href="#cb2-20" aria-hidden="true"></a>    <span class="fu">}</span><span class="ot">,</span></span>
<span id="cb2-21"><a href="#cb2-21" aria-hidden="true"></a>    <span class="fu">{</span></span>
<span id="cb2-22"><a href="#cb2-22" aria-hidden="true"></a>      <span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Awan&quot;</span><span class="fu">,</span></span>
<span id="cb2-23"><a href="#cb2-23" aria-hidden="true"></a>      <span class="dt">&quot;children&quot;</span><span class="fu">:</span> <span class="ot">[</span></span>
<span id="cb2-24"><a href="#cb2-24" aria-hidden="true"></a>        <span class="fu">{</span></span>
<span id="cb2-25"><a href="#cb2-25" aria-hidden="true"></a>          <span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Enoch&quot;</span></span>
<span id="cb2-26"><a href="#cb2-26" aria-hidden="true"></a>        <span class="fu">}</span></span>
<span id="cb2-27"><a href="#cb2-27" aria-hidden="true"></a>      <span class="ot">]</span></span>
<span id="cb2-28"><a href="#cb2-28" aria-hidden="true"></a>    <span class="fu">}</span><span class="ot">,</span></span>
<span id="cb2-29"><a href="#cb2-29" aria-hidden="true"></a>    <span class="fu">{</span></span>
<span id="cb2-30"><a href="#cb2-30" aria-hidden="true"></a>      <span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Azura&quot;</span></span>
...
<span id="cb2-33"><a href="#cb2-33" aria-hidden="true"></a><span class="fu">}</span></span></code></pre></div>
...
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb3-1"><a href="#cb3-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">children</span>(d) {</span>
<span id="cb3-2"><a href="#cb3-2" aria-hidden="true"></a>  <span class="cf">return</span> d<span class="op">.</span><span class="at">children</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb4-1"><a href="#cb4-1" aria-hidden="true"></a><span class="bu">root</span><span class="op">.</span><span class="fu">sum</span>(<span class="kw">function</span>(d) { <span class="cf">return</span> d<span class="op">.</span><span class="at">value</span> <span class="op">?</span> <span class="dv">1</span> <span class="op">:</span> <span class="dv">0</span><span class="op">;</span> })<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb5-1"><a href="#cb5-1" aria-hidden="true"></a><span class="kw">var</span> treemap <span class="op">=</span> d3<span class="op">.</span><span class="fu">treemap</span>()</span>
<span id="cb5-2"><a href="#cb5-2" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">size</span>([width<span class="op">,</span> height])</span>
<span id="cb5-3"><a href="#cb5-3" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">padding</span>(<span class="dv">2</span>)<span class="op">;</span></span>
<span id="cb5-4"><a href="#cb5-4" aria-hidden="true"></a></span>
<span id="cb5-5"><a href="#cb5-5" aria-hidden="true"></a><span class="kw">var</span> nodes <span class="op">=</span> <span class="fu">treemap</span>(<span class="bu">root</span></span>
<span id="cb5-6"><a href="#cb5-6" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">sum</span>(<span class="kw">function</span>(d) { <span class="cf">return</span> d<span class="op">.</span><span class="at">value</span><span class="op">;</span> })</span>
<span id="cb5-7"><a href="#cb5-7" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">sort</span>(<span class="kw">function</span>(a<span class="op">,</span> b) { <span class="cf">return</span> b<span class="op">.</span><span class="at">height</span> <span class="op">-</span> a<span class="op">.</span><span class="at">height</span> <span class="op">||</span> b<span class="op">.</span><span class="at">value</span> <span class="op">-</span> a<span class="op">.</span><span class="at">value</span><span class="op">;</span> }))</span>
<span id="cb5-8"><a href="#cb5-8" aria-hidden="true"></a>  <span class="op">.</span><span class="fu">descendants</span>()<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb6"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb6-1"><a href="#cb6-1" aria-hidden="true"></a><span class="bu">root</span></span>
<span id="cb6-2"><a href="#cb6-2" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">sum</span>(<span class="kw">function</span>(d) { <span class="cf">return</span> d<span class="op">.</span><span class="at">value</span><span class="op">;</span> })</span>
<span id="cb6-3"><a href="#cb6-3" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">sort</span>(<span class="kw">function</span>(a<span class="op">,</span> b) { <span class="cf">return</span> b<span class="op">.</span><span class="at">value</span> <span class="op">-</span> a<span class="op">.</span><span class="at">value</span><span class="op">;</span> })<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb7-1"><a href="#cb7-1" aria-hidden="true"></a><span class="bu">root</span></span>
<span id="cb7-2"><a href="#cb7-2" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">sum</span>(<span class="kw">function</span>(d) { <span class="cf">return</span> d<span class="op">.</span><span class="at">value</span><span class="op">;</span> })</span>
<span id="cb7-3"><a href="#cb7-3" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">sort</span>(<span class="kw">function</span>(a<span class="op">,</span> b) { <span class="cf">return</span> b<span class="op">.</span><span class="at">height</span> <span class="op">-</span> a<span class="op">.</span><span class="at">height</span> <span class="op">||</span> b<span class="op">.</span><span class="at">value</span> <span class="op">-</span> a<span class="op">.</span><span class="at">value</span><span class="op">;</span> })<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb8"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb8-1"><a href="#cb8-1" aria-hidden="true"></a><span class="bu">root</span></span>
<span id="cb8-2"><a href="#cb8-2" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">sum</span>(<span class="kw">function</span>(d) { <span class="cf">return</span> d<span class="op">.</span><span class="at">value</span><span class="op">;</span> })</span>
<span id="cb8-3"><a href="#cb8-3" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">sort</span>(<span class="kw">function</span>(a<span class="op">,</span> b) { <span class="cf">return</span> b<span class="op">.</span><span class="at">height</span> <span class="op">-</span> a<span class="op">.</span><span class="at">height</span> <span class="op">||</span> a<span class="op">.</span><span class="at">id</span><span class="op">.</span><span class="fu">localeCompare</span>(b<span class="op">.</span><span class="at">id</span>)<span class="op">;</span> })<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb10"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb10-1"><a href="#cb10-1" aria-hidden="true"></a><span class="kw">var</span> table <span class="op">=</span> d3<span class="op">.</span><span class="fu">csvParse</span>(text)<span class="op">;</span></span></code></pre></div>
<p>This returns:</p>
<div class="sourceCode" id="cb11"><pre class="sourceCode json"><code class="sourceCode json"><span id="cb11-1"><a href="#cb11-1" aria-hidden="true"></a><span class="ot">[</span></span>
<span id="cb11-2"><a href="#cb11-2" aria-hidden="true"></a>  <span class="fu">{</span><span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Eve&quot;</span><span class="fu">,</span>   <span class="dt">&quot;parent&quot;</span><span class="fu">:</span> <span class="st">&quot;&quot;</span><span class="fu">}</span><span class="ot">,</span></span>
<span id="cb11-3"><a href="#cb11-3" aria-hidden="true"></a>  <span class="fu">{</span><span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Cain&quot;</span><span class="fu">,</span>  <span class="dt">&quot;parent&quot;</span><span class="fu">:</span> <span class="st">&quot;Eve&quot;</span><span class="fu">}</span><span class="ot">,</span></span>
<span id="cb11-4"><a href="#cb11-4" aria-hidden="true"></a>  <span class="fu">{</span><span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Seth&quot;</span><span class="fu">,</span>  <span class="dt">&quot;parent&quot;</span><span class="fu">:</span> <span class="st">&quot;Eve&quot;</span><span class="fu">}</span><span class="ot">,</span></span>
<span id="cb11-5"><a href="#cb11-5" aria-hidden="true"></a>  <span class="fu">{</span><span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Enos&quot;</span><span class="fu">,</span>  <span class="dt">&quot;parent&quot;</span><span class="fu">:</span> <span class="st">&quot;Seth&quot;</span><span class="fu">}</span><span class="ot">,</span></span>
<span id="cb11-6"><a href="#cb11-6" aria-hidden="true"></a>  <span class="fu">{</span><span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Noam&quot;</span><span class="fu">,</span>  <span class="dt">&quot;parent&quot;</span><span class="fu">:</span> <span class="st">&quot;Seth&quot;</span><span class="fu">}</span><span class="ot">,</span></span>
<span id="cb11-7"><a href="#cb11-7" aria-hidden="true"></a>  <span class="fu">{</span><span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Abel&quot;</span><span class="fu">,</span>  <span class="dt">&quot;parent&quot;</span><span class="fu">:</span> <span class="st">&quot;Eve&quot;</span><span class="fu">}</span><span class="ot">,</span></span>
<span id="cb11-8"><a href="#cb11-8" aria-hidden="true"></a>  <span class="fu">{</span><span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Awan&quot;</span><span class="fu">,</span>  <span class="dt">&quot;parent&quot;</span><span class="fu">:</span> <span class="st">&quot;Eve&quot;</span><span class="fu">}</span><span class="ot">,</span></span>
<span id="cb11-9"><a href="#cb11-9" aria-hidden="true"></a>  <span class="fu">{</span><span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Enoch&quot;</span><span class="fu">,</span> <span class="dt">&quot;parent&quot;</span><span class="fu">:</span> <span class="st">&quot;Awan&quot;</span><span class="fu">}</span><span class="ot">,</span></span>
<span id="cb11-10"><a href="#cb11-10" aria-hidden="true"></a>  <span class="fu">{</span><span class="dt">&quot;name&quot;</span><span class="fu">:</span> <span class="st">&quot;Azura&quot;</span><span class="fu">,</span> <span class="dt">&quot;parent&quot;</span><span class="fu">:</span> <span class="st">&quot;Eve&quot;</span><span class="fu">}</span></span>
<span id="cb11-11"><a href="#cb11-11" aria-hidden="true"></a><span class="ot">]</span></span></code></pre></div>
<p>To convert to a hierarchy:</p>
<div class="sourceCode" id="cb12"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb12-1"><a href="#cb12-1" aria-hidden="true"></a><span class="kw">var</span> <span class="bu">root</span> <span class="op">=</span> d3<span class="op">.</span><span class="fu">stratify</span>()</span>
<span id="cb12-2"><a href="#cb12-2" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">id</span>(<span class="kw">function</span>(d) { <span class="cf">return</span> d<span class="op">.</span><span class="at">name</span><span class="op">;</span> })</span>
<span id="cb12-3"><a href="#cb12-3" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">parentId</span>(<span class="kw">function</span>(d) { <span class="cf">return</span> d<span class="op">.</span><span class="at">parent</span><span class="op">;</span> })</span>
<span id="cb12-4"><a href="#cb12-4" aria-hidden="true"></a>    (table)<span class="op">;</span></span></code></pre></div>
<p>This returns:</p>
...
<div class="sourceCode" id="cb13"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb13-1"><a href="#cb13-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">id</span>(d) {</span>
<span id="cb13-2"><a href="#cb13-2" aria-hidden="true"></a>  <span class="cf">return</span> d<span class="op">.</span><span class="at">id</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb14"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb14-1"><a href="#cb14-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">parentId</span>(d) {</span>
<span id="cb14-2"><a href="#cb14-2" aria-hidden="true"></a>  <span class="cf">return</span> d<span class="op">.</span><span class="at">parentId</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb15"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb15-1"><a href="#cb15-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">separation</span>(a<span class="op">,</span> b) {</span>
<span id="cb15-2"><a href="#cb15-2" aria-hidden="true"></a>  <span class="cf">return</span> a<span class="op">.</span><span class="at">parent</span> <span class="op">==</span> b<span class="op">.</span><span class="at">parent</span> <span class="op">?</span> <span class="dv">1</span> <span class="op">:</span> <span class="dv">2</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb16"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb16-1"><a href="#cb16-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">separation</span>(a<span class="op">,</span> b) {</span>
<span id="cb16-2"><a href="#cb16-2" aria-hidden="true"></a>  <span class="cf">return</span> a<span class="op">.</span><span class="at">parent</span> <span class="op">==</span> b<span class="op">.</span><span class="at">parent</span> <span class="op">?</span> <span class="dv">1</span> <span class="op">:</span> <span class="dv">2</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb17"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb17-1"><a href="#cb17-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">separation</span>(a<span class="op">,</span> b) {</span>
<span id="cb17-2"><a href="#cb17-2" aria-hidden="true"></a>  <span class="cf">return</span> (a<span class="op">.</span><span class="at">parent</span> <span class="op">==</span> b<span class="op">.</span><span class="at">parent</span> <span class="op">?</span> <span class="dv">1</span> <span class="op">:</span> <span class="dv">2</span>) <span class="op">/</span> a<span class="op">.</span><span class="at">depth</span><span class="op">;</span></span>
