...
<div class="sourceCode" id="cb1"><pre class="sourceCode html"><code class="sourceCode html"><span id="cb1-1"><a href="#cb1-1" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-dispatch.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-2"><a href="#cb1-2" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-selection.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-3"><a href="#cb1-3" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-drag.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-4"><a href="#cb1-4" aria-hidden="true"></a><span class="kw">&lt;script&gt;</span></span>
<span id="cb1-5"><a href="#cb1-5" aria-hidden="true"></a></span>
<span id="cb1-6"><a href="#cb1-6" aria-hidden="true"></a><span class="kw">var</span> drag <span class="op">=</span> d3<span class="op">.</span><span class="fu">drag</span>()<span class="op">;</span></span>
...
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb3-1"><a href="#cb3-1" aria-hidden="true"></a>selection<span class="op">.</span><span class="fu">on</span>(<span class="st">&quot;.drag&quot;</span><span class="op">,</span> <span class="kw">null</span>)<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb4-1"><a href="#cb4-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">container</span>() {</span>
<span id="cb4-2"><a href="#cb4-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="kw">this</span><span class="op">.</span><span class="at">parentNode</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb5-1"><a href="#cb5-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">container</span>() {</span>
<span id="cb5-2"><a href="#cb5-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="kw">this</span><span class="op">;</span></span>
...
<span id="cb6-2"><a href="#cb6-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="op">!</span>d3<span class="op">.</span><span class="at">event</span><span class="op">.</span><span class="at">button</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb7-1"><a href="#cb7-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">touchable</span>() {</span>
<span id="cb7-2"><a href="#cb7-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="st">&quot;ontouchstart&quot;</span> <span class="kw">in</span> <span class="kw">this</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb8"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb8-1"><a href="#cb8-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">subject</span>(d) {</span>
<span id="cb8-2"><a href="#cb8-2" aria-hidden="true"></a>  <span class="cf">return</span> d <span class="op">==</span> <span class="kw">null</span> <span class="op">?</span> {<span class="dt">x</span><span class="op">:</span> d3<span class="op">.</span><span class="at">event</span><span class="op">.</span><span class="at">x</span><span class="op">,</span> <span class="dt">y</span><span class="op">:</span> d3<span class="op">.</span><span class="at">event</span><span class="op">.</span><span class="at">y</span>} <span class="op">:</span> d<span class="op">;</span></span>
...
<div class="sourceCode" id="cb9"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb9-1"><a href="#cb9-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">subject</span>() {</span>
<span id="cb9-2"><a href="#cb9-2" aria-hidden="true"></a>  <span class="kw">var</span> n <span class="op">=</span> circles<span class="op">.</span><span class="at">length</span><span class="op">,</span></span>
<span id="cb9-3"><a href="#cb9-3" aria-hidden="true"></a>      i<span class="op">,</span></span>
<span id="cb9-4"><a href="#cb9-4" aria-hidden="true"></a>      dx<span class="op">,</span></span>
<span id="cb9-5"><a href="#cb9-5" aria-hidden="true"></a>      dy<span class="op">,</span></span>
<span id="cb9-6"><a href="#cb9-6" aria-hidden="true"></a>      d2<span class="op">,</span></span>
<span id="cb9-7"><a href="#cb9-7" aria-hidden="true"></a>      s2 <span class="op">=</span> radius <span class="op">*</span> radius<span class="op">,</span></span>
<span id="cb9-8"><a href="#cb9-8" aria-hidden="true"></a>      circle<span class="op">,</span></span>
<span id="cb9-9"><a href="#cb9-9" aria-hidden="true"></a>      subject<span class="op">;</span></span>
<span id="cb9-10"><a href="#cb9-10" aria-hidden="true"></a></span>
<span id="cb9-11"><a href="#cb9-11" aria-hidden="true"></a>  <span class="cf">for</span> (i <span class="op">=</span> <span class="dv">0</span><span class="op">;</span> i <span class="op">&lt;</span> n<span class="op">;</span> <span class="op">++</span>i) {</span>
<span id="cb9-12"><a href="#cb9-12" aria-hidden="true"></a>    circle <span class="op">=</span> circles[i]<span class="op">;</span></span>
<span id="cb9-13"><a href="#cb9-13" aria-hidden="true"></a>    dx <span class="op">=</span> d3<span class="op">.</span><span class="at">event</span><span class="op">.</span><span class="at">x</span> <span class="op">-</span> circle<span class="op">.</span><span class="at">x</span><span class="op">;</span></span>
<span id="cb9-14"><a href="#cb9-14" aria-hidden="true"></a>    dy <span class="op">=</span> d3<span class="op">.</span><span class="at">event</span><span class="op">.</span><span class="at">y</span> <span class="op">-</span> circle<span class="op">.</span><span class="at">y</span><span class="op">;</span></span>
<span id="cb9-15"><a href="#cb9-15" aria-hidden="true"></a>    d2 <span class="op">=</span> dx <span class="op">*</span> dx <span class="op">+</span> dy <span class="op">*</span> dy<span class="op">;</span></span>
<span id="cb9-16"><a href="#cb9-16" aria-hidden="true"></a>    <span class="cf">if</span> (d2 <span class="op">&lt;</span> s2) subject <span class="op">=</span> circle<span class="op">,</span> s2 <span class="op">=</span> d2<span class="op">;</span></span>
<span id="cb9-17"><a href="#cb9-17" aria-hidden="true"></a>  }</span>
<span id="cb9-18"><a href="#cb9-18" aria-hidden="true"></a></span>
<span id="cb9-19"><a href="#cb9-19" aria-hidden="true"></a>  <span class="cf">return</span> subject<span class="op">;</span></span>
...
<div class="sourceCode" id="cb10"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb10-1"><a href="#cb10-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">started</span>() {</span>
<span id="cb10-2"><a href="#cb10-2" aria-hidden="true"></a>  <span class="kw">var</span> circle <span class="op">=</span> d3<span class="op">.</span><span class="fu">select</span>(<span class="kw">this</span>)<span class="op">.</span><span class="fu">classed</span>(<span class="st">&quot;dragging&quot;</span><span class="op">,</span> <span class="kw">true</span>)<span class="op">;</span></span>
<span id="cb10-3"><a href="#cb10-3" aria-hidden="true"></a></span>
<span id="cb10-4"><a href="#cb10-4" aria-hidden="true"></a>  d3<span class="op">.</span><span class="at">event</span><span class="op">.</span><span class="fu">on</span>(<span class="st">&quot;drag&quot;</span><span class="op">,</span> dragged)<span class="op">.</span><span class="fu">on</span>(<span class="st">&quot;end&quot;</span><span class="op">,</span> ended)<span class="op">;</span></span>
<span id="cb10-5"><a href="#cb10-5" aria-hidden="true"></a></span>
<span id="cb10-6"><a href="#cb10-6" aria-hidden="true"></a>  <span class="kw">function</span> <span class="fu">dragged</span>(d) {</span>
<span id="cb10-7"><a href="#cb10-7" aria-hidden="true"></a>    circle<span class="op">.</span><span class="fu">raise</span>()<span class="op">.</span><span class="fu">attr</span>(<span class="st">&quot;cx&quot;</span><span class="op">,</span> d<span class="op">.</span><span class="at">x</span> <span class="op">=</span> d3<span class="op">.</span><span class="at">event</span><span class="op">.</span><span class="at">x</span>)<span class="op">.</span><span class="fu">attr</span>(<span class="st">&quot;cy&quot;</span><span class="op">,</span> d<span class="op">.</span><span class="at">y</span> <span class="op">=</span> d3<span class="op">.</span><span class="at">event</span><span class="op">.</span><span class="at">y</span>)<span class="op">;</span></span>
<span id="cb10-8"><a href="#cb10-8" aria-hidden="true"></a>  }</span>
<span id="cb10-9"><a href="#cb10-9" aria-hidden="true"></a></span>
<span id="cb10-10"><a href="#cb10-10" aria-hidden="true"></a>  <span class="kw">function</span> <span class="fu">ended</span>() {</span>
<span id="cb10-11"><a href="#cb10-11" aria-hidden="true"></a>    circle<span class="op">.</span><span class="fu">classed</span>(<span class="st">&quot;dragging&quot;</span><span class="op">,</span> <span class="kw">false</span>)<span class="op">;</span></span>
