...
<div class="sourceCode" id="cb1"><pre class="sourceCode html"><code class="sourceCode html"><span id="cb1-1"><a href="#cb1-1" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-voronoi.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-2"><a href="#cb1-2" aria-hidden="true"></a><span class="kw">&lt;script&gt;</span></span>
<span id="cb1-3"><a href="#cb1-3" aria-hidden="true"></a></span>
<span id="cb1-4"><a href="#cb1-4" aria-hidden="true"></a><span class="kw">var</span> voronoi <span class="op">=</span> d3<span class="op">.</span><span class="fu">voronoi</span>()<span class="op">;</span></span>
...
<div class="sourceCode" id="cb2"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb2-1"><a href="#cb2-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">x</span>(d) {</span>
<span id="cb2-2"><a href="#cb2-2" aria-hidden="true"></a>  <span class="cf">return</span> d[<span class="dv">0</span>]<span class="op">;</span></span>
...
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb3-1"><a href="#cb3-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">y</span>(d) {</span>
<span id="cb3-2"><a href="#cb3-2" aria-hidden="true"></a>  <span class="cf">return</span> d[<span class="dv">1</span>]<span class="op">;</span></span>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb4-1"><a href="#cb4-1" aria-hidden="true"></a>voronoi<span class="op">.</span><span class="fu">extent</span>([[<span class="dv">0</span><span class="op">,</span> <span class="dv">0</span>]<span class="op">,</span> size])<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb5-1"><a href="#cb5-1" aria-hidden="true"></a><span class="fu">voronoi</span>(data)<span class="op">.</span><span class="fu">polygons</span>()<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb6"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb6-1"><a href="#cb6-1" aria-hidden="true"></a><span class="fu">voronoi</span>(data)<span class="op">.</span><span class="fu">triangles</span>()<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb7-1"><a href="#cb7-1" aria-hidden="true"></a><span class="fu">voronoi</span>(data)<span class="op">.</span><span class="fu">links</span>()<span class="op">;</span></span></code></pre></div>
